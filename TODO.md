...
- [x] **GregMat dataset integrated** — 1,114 words × groups 1–38 (32 Oxford-style groups from `HFV Essential.pdf` + 6 filled-in groups), 38 group decks on Home (`feat/gregmat-dataset`)
